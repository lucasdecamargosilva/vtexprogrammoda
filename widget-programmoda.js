(function () {
    // Programmoda: provador desativado após 500 provas no ciclo atual.
    return;
    ...
    /* Programmoda: loja so de roupa, sem bloqueio por categoria */
    ...
    // ===============================================
    const apiKey = "pl_live_7f39d7d8cf23fddbb4c1e4543e19c3e5dea86e9362a5ffd7499d81be8717164d";
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
        ...
        .q-size-rec-value {
            ...
            letter-spacing: 0; color: var(--c-ink); line-height: 1; white-space: nowrap;
        }
        .q-size-rec-aviso {
    ...
    function init() {
        ...
        inlineBtn.addEventListener('click', (e) => {
            ...
            e.preventDefault();
            e.stopPropagation();
            const prodName = document.querySelector('[class*="productNameContainer"] h1, h1.product__title, h1')?.innerText || document.title;
